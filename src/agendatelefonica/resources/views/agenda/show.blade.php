...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a>Ver el</a></li>
                    ...
                    <div class="row register-form">
                        ...
                        <div class="col-md-6">                                        
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombres" value="{{$agenda->nombres}}" disabled="true" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="telefono" placeholder="Telefono: 18491115555" value="{{$agenda->telefono}}" disabled="true"  id="telefono">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="celular" placeholder="Celular: 18491115555" value="{{$agenda->celular}}" disabled="true" id="Celular">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="maxl">
                                    <label class="radio inline"> 
                                        <input type="radio" name="sexo" value="Masculino" disabled="true" {{ $hombre }}>
                                        <span> Masculino </span> 
                                    </label>
                                    <label class="radio inline"> 
                                        <input type="radio" name="sexo" value="Femenino"  disabled="true" {{ $mujer }}>
                                        <span>Femenino </span> 
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="Email" disabled="true" value="{{$agenda->email}}"  />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="posicion" class="form-control" placeholder="Posición" disabled="true" value="{{$agenda->posicion}}"  />
                                </div>
                            </div>
                        @php ($departamentos=['Gerencia de TI',"Auditoria TI",'Contabilidad'])
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="salario" placeholder="salario *" disabled="true" value="{{$agenda->salario}}"  />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="fechadenacimiento" id="fechadenacimiento" min="1000-01-01"
                                        max="3000-12-31" class="form-control" disabled="true" value="{{$agenda->fechadenacimiento}}" >                                                   
                                </div>
                            </div>
